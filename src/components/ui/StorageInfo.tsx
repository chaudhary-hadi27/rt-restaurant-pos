// src/components/ui/StorageInfo.tsx - COMPLETE VERSION
'use client'

import { useState, useEffect } from 'react'
import { Database, Trash2, X, HardDrive, Image, ShoppingCart } from 'lucide-react'

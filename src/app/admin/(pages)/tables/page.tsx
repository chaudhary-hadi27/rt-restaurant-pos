                        ...
                        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-4">
                            <div className="flex items-center justify-between gap-3">
                                <div className="min-w-0 flex-1">
                                    ...
                                    <p className="text-xs sm:text-sm text-[var(--muted)] mt-0.5">{filtered.length} tables • {sections.length} sections</p>
                                </div>
                                ...
                                {filtered.map((table: any) => (
                                    <div key={table.id} className="p-2.5 sm:p-3 lg:p-4 bg-[var(--card)] border border-[var(--border)] rounded-lg hover:shadow-lg hover:border-blue-600 transition-all group">
                                        <div className="flex items-center justify-between mb-2 sm:mb-3">
                                            ...
                                            <span className="px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-md text-xs font-medium capitalize" style={{ backgroundColor: `${getTableStatusColor(table.status)}20`, color: getTableStatusColor(table.status) }} title="Managed by staff">
                                            {table.status}
                                        </span>
                                        </div>
